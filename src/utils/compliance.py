...
def sanitize_raw_listing_record(record: dict[str, Any]) -> dict[str, Any]:
    ...
    raw_record = {
        ...
        "description_raw": record.get("description_raw", record.get("description")),
        ...
        "property_type_raw": record.get("property_type_raw", record.get("property_type")),
        "listing_type_raw": record.get("listing_type_raw", record.get("listing_type")),
        ...
        "latitude_raw": record.get("latitude_raw", record.get("latitude")),
        "longitude_raw": record.get("longitude_raw", record.get("longitude")),
        "construction_year_raw": record.get(
            "construction_year_raw", record.get("construction_year")
        ),
        "attributes_raw": record.get("attributes_raw", record.get("attributes")),
        "listing_url": normalize_listing_url(record.get("listing_url")),
        "scraped_at": record.get("scraped_at"),
        "batch_id": record.get("batch_id"),
        "source": record.get("source"),
        "detail_scraped": record.get("detail_scraped"),
    }
...
def sanitize_clean_listing_record(record: dict[str, Any]) -> dict[str, Any]:
    ...
    clean_record = {
        ...
        "description_clean": record.get("description_clean", record.get("description")),
        ...
        "rooms_total": record.get("rooms_total"),
        "price_per_room": record.get("price_per_room"),
        "room_density": record.get("room_density"),
        "luxury_flag": record.get("luxury_flag"),
        "coastal_city": record.get("coastal_city"),
        "property_age_bucket": record.get("property_age_bucket"),
        "surface_x_rooms": record.get("surface_x_rooms"),
        "bathrooms_per_bedroom": record.get("bathrooms_per_bedroom"),
        "extraction_score": record.get("extraction_score"),
        "feature_completeness_score": record.get("feature_completeness_score"),
        "listing_url": normalize_listing_url(record.get("listing_url")),
        "scraped_at": record.get("scraped_at"),
        "batch_id": record.get("batch_id"),
    }
